...
func Get(ctx__ context.Context, wrpc__ wrpc.Invoker, bucket string, key string) (r0__ *wrpc.Result[[]uint8, Error], close__ func() error, err__ error) {
	if err__ = wrpc__.Invoke(ctx__, "wrpc:keyvalue/store@0.2.0-draft", "get", func(w__ wrpc.IndexWriter, r__ wrpc.IndexReadCloser) error {
		close__ = r__.Close
...
//
// If any other error occurs, it returns an `Err(error)`.
func Set(ctx__ context.Context, wrpc__ wrpc.Invoker, bucket string, key string, value []uint8) (r0__ *wrpc.Result[struct{}, Error], close__ func() error, err__ error) {
	if err__ = wrpc__.Invoke(ctx__, "wrpc:keyvalue/store@0.2.0-draft", "set", func(w__ wrpc.IndexWriter, r__ wrpc.IndexReadCloser) error {
		close__ = r__.Close
		var buf__ bytes.Buffer
...
//
// If any other error occurs, it returns an `Err(error)`.
func Delete(ctx__ context.Context, wrpc__ wrpc.Invoker, bucket string, key string) (r0__ *wrpc.Result[struct{}, Error], close__ func() error, err__ error) {
	if err__ = wrpc__.Invoke(ctx__, "wrpc:keyvalue/store@0.2.0-draft", "delete", func(w__ wrpc.IndexWriter, r__ wrpc.IndexReadCloser) error {
		close__ = r__.Close
		var buf__ bytes.Buffer
		writes__ := make(map[uint32]func(wrpc.IndexWriter) error, 2)
		write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
...
//
// If any other error occurs, it returns an `Err(error)`.
func Exists(ctx__ context.Context, wrpc__ wrpc.Invoker, bucket string, key string) (r0__ *wrpc.Result[bool, Error], close__ func() error, err__ error) {
	if err__ = wrpc__.Invoke(ctx__, "wrpc:keyvalue/store@0.2.0-draft", "exists", func(w__ wrpc.IndexWriter, r__ wrpc.IndexReadCloser) error {
		close__ = r__.Close
		var buf__ bytes.Buffer
		writes__ := make(map[uint32]func(wrpc.IndexWriter) error, 2)
		write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
...
func ListKeys(ctx__ context.Context, wrpc__ wrpc.Invoker, bucket string, cursor *uint64) (r0__ *wrpc.Result[KeyResponse, Error], close__ func() error, err__ error) {
	if err__ = wrpc__.Invoke(ctx__, "wrpc:keyvalue/store@0.2.0-draft", "list-keys", func(w__ wrpc.IndexWriter, r__ wrpc.IndexReadCloser) error {
		close__ = r__.Close
		var buf__ bytes.Buffer
		writes__ := make(map[uint32]func(wrpc.IndexWriter) error, 2)
		write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		...
		if err__ != nil {
			return fmt.Errorf("failed to write `cursor` parameter: %w", err__)
		}
		if write1__ != nil {
			writes__[1] = write1__
		}
